---
title: "GPS 102: Interactive Playback with grz_playback_gps()"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{GPS 102: Interactive Playback with grz_playback_gps()}
...
This tutorial shows how to build an interactive playback map for visual QA
using `grz_playback_gps()`. The playback map is useful immediately after data
validation, before downstream summaries and modelling.
...
The widget below is rendered directly in the tutorial, so it also appears in
the GitHub Pages site after pkgdown build/deploy.
...
Continue to GPS 103 for activity classification and label-based validation:

- GMM + HMM state classification
- manual labelling with `grz_label_gps_states()`
