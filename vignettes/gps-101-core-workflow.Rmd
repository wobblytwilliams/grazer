...
playback_pkgs <- c("leaflet", "leaftime", "htmlwidgets")
playback_pkgs_ok <- all(vapply(playback_pkgs, requireNamespace, logical(1), quietly = TRUE))
```
...
- timeline playback QA with `grz_playback_gps()`,
